...
<html>
    <head>
        ...
        <link type="text/css" rel="stylesheet" media="all" href="../css/MyDashBoard.css" />
        <!--Gallerific plug in-->
    ...
    <body>
        ...
        <?php  DisplayHeader($displayName,$role); ?>
        <div id="content">
            <div id="page">
                
			<div id="container">
                            <div id="leftContainer">To do Nav container :<br/>User Friendly Nav UI<br/>File browser<br/>Upload link<br/>Edit photo properties</div>
				...
				<div style="clear: both;"></div>
                                <!--<div id="rightContainer">&nbsp;stuff</div>-->
			</div>
		</div>
        </div>
        <?php
